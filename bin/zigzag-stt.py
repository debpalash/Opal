#!/usr/bin/env python3
"""zigzag one-shot STT — transcribe a WAV file to stdout.

Usage:  python3 bin/zigzag-stt.py /path/to/audio.wav
...
model size with ZIGZAG_STT_MODEL (tiny.en / base.en / small.en / ...).
"""
import os
import sys
...
def main() -> int:
    if len(sys.argv) < 2:
        _eprint("usage: zigzag-stt.py <wav>")
        return 2
    wav = sys.argv[1]
