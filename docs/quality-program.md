...
| Bounded shared artwork decode | The shared cover decoder probes untrusted image headers before stb allocation, rejects invalid/overflowing dimensions and caps each decoded RGBA cover at 24 MiB (192 MiB at the eight-worker ceiling); the poster daemon and durable-queue thumbnails both use it |
