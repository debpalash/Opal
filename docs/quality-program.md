...
| Web performance observability | The client measures boot-to-painted-shell, Event Timing interaction p95, and bounded long-task samples in session memory and exposes them in Diagnostics. Measurements retain no URLs, control labels, or user content. |
