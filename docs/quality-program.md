...
| Unified cross-content details | Plex, Jellyfin, Audiobookshelf, OPDS, podcast-show and podcast-episode rows open one responsive semantic dialog with available source metadata and the correct open/read/play/resume/account actions; native modal focus trapping, Escape, outside-click close and trigger-focus restoration align mouse, touch and keyboard behavior |
