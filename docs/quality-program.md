...
| Unified self-hosted details | Plex and Jellyfin rows open one responsive semantic dialog with server-owned overview, metadata, resume/play and account mutations; native modal focus trapping, Escape, outside-click close and trigger-focus restoration keep mouse, touch and keyboard behavior aligned |
