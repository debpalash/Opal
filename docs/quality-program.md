...
| Bounded library rendering | Web Watching renders a persisted 24/48/96-item page, clamps stale page state after filtering or removal, and provides keyboard-accessible previous/next navigation. Large libraries no longer create an unbounded DOM. |
